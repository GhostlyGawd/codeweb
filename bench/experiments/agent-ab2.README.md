...
- Corpus clones at `bench/corpus/{axios,flask,express}` (read-only; any pinned revision — the
...
```
Workflow({ scriptPath: "bench/experiments/agent-ab2-ambient.workflow.js",
...
Persist the returned `{tasks, cells, config}` to `bench/results/agent-ab2-raw.json`, then analyze
(deterministic, seeded):

```
node bench/experiments/agent-ab-analyze.mjs bench/results/agent-ab2-raw.json bench/results/agent-ab2.json
```
