...
//      bench/results/agent-ab.json interpretation). v2 tasks must have real blast radius:
...
// Then:  node bench/experiments/agent-ab-analyze.mjs bench/results/agent-ab2-raw.json bench/results/agent-ab2.json
...
const cfg = {
  corpus: (args && args.corpus) || `${ROOT}/bench/corpus`,
...
${ROOT}/bench/results/agent-ab2-tasks.json as {frozenAt:"pre-solve", designVariant:"v2-ambient-hard",
