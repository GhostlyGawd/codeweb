...
test('the real repo derives 21 MCP tools from the source', () => {
  assert.equal(mcpToolCount(PLUGIN_ROOT), 21);
  assert.equal(productToolCount(PLUGIN_ROOT), 21, 'product.json must list exactly the MCP tools');
});
