...
- `npm test` passes locally (the full suite — the count grows release to release; a handful of environment skips are fine: golden-target-absence, optional typescript, engine-fallback inverse).
