...
if (payload.found === false) {
  ...
  die(`symbol not found: ${opts.symbol}${near} (concept search: find.mjs "<free text>")`, code);
}
const p = payload;
if (p.analysis?.status === 'incomplete') console.log(`  analysis: ${p.analysis.nextSteps.join(' ')}`);
