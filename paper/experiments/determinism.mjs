...
//
// Pre-registered hypotheses (paper/PRE-REGISTRATION.md §5, Theme 1):
...
//
// Runs end-to-end:  node paper/experiments/determinism.mjs
// Writes:           paper/results/determinism.json
