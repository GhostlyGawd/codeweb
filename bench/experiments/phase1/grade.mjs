...
const go = JSON.parse(readFileSync('bench/experiments/phase1/truth.go-route.json'));
const rs = JSON.parse(readFileSync('bench/experiments/phase1/truth.rust-escape.json'));
