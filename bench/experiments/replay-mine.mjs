...
//
//   node bench/experiments/replay-mine.mjs <repo> [--max-commits 300] [--min-callers 3]
//        [--followup-window 5] [--max-tasks 12] [--out bench/results/replay-tasks.json]
//
...
let repo = null, maxCommits = 300, minCallers = 3, window_ = 5, maxTasks = 12, outPath = 'bench/results/replay-tasks.json', maxPairs = 40;
