...
//   node bench/experiments/agent-ab-analyze.mjs [raw.json] [out.json]
//   (defaults: bench/results/agent-ab-raw.json -> bench/results/agent-ab.json; the v2 rerun
...
const RAW_PATH = process.argv[2] ? resolve(process.argv[2]) : join(ROOT, 'bench/results/agent-ab-raw.json');
const OUT_PATH = process.argv[3] ? resolve(process.argv[3]) : join(ROOT, 'bench/results/agent-ab.json');
