...
//   node paper/experiments/auxiliary.mjs
// prints one PASS/FAIL line per check, writes paper/results/auxiliary.json, and exits non-zero
// if ANY check fails (so paper/run-all.mjs can gate on it).
//
...
const RESULTS = join(ROOT, 'paper', 'results', 'auxiliary.json');
