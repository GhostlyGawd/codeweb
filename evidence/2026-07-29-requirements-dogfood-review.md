...
1. Review the structured rewrite for source fidelity, coverage, conflicts,
   feasibility, and verification adequacy.
2. Correct all review findings and rerun the checker.
3. Record operator baseline approval only against the final content digest.
...
| Structured requirement records | Supporting trace artifact | No behavior change | Requirements checker | Companion YAML and generated report | Complete for human review; baseline remains open. |
