...
//   node bench/experiments/replay-analyze.mjs [raw.json] [out.json]
...
const RAW_PATH = process.argv[2] ? resolve(process.argv[2]) : join(ROOT, 'bench/results/replay-ab-raw.json');
const OUT_PATH = process.argv[3] ? resolve(process.argv[3]) : join(ROOT, 'bench/results/replay-ab.json');
