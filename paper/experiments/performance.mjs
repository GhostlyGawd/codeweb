...
// Standalone, deterministic, zero-dependency. Run end-to-end with:  node paper/experiments/performance.mjs
//
// Hypotheses (criteria fixed in paper/PRE-REGISTRATION.md §5, Theme 4):
...
//  · Stats come from the shared, self-tested paper/lib/stats.mjs (olsLogLog/median/quantile) — never
//    hand-rolled here.
...
const CORPUS = join(ROOT, 'paper', 'corpus');
const RESULTS = join(ROOT, 'paper', 'results', 'performance.json');
