...
//
// Usage: node paper/experiments/efficiency-pilot.usage.mjs                       (defaults to the reps8 run)
//        node paper/experiments/efficiency-pilot.usage.mjs --journal <wf_*.json> [--transcripts <dir>] [--out <path>] [--json]
// Writes: paper/experiments/efficiency-pilot.usage.json
